 ...
 *
 * Фон намеренно чёрный в любой теме: логотип нарисован на чёрном, и любой другой
 * фон дал бы вокруг него видимый квадрат. Экран загрузки, который темнее остального
 * приложения, читается нормально — так устроены заставки в играх.
 *
...
export function SplashScreen() {
  ...
  return (
    <div className="splash" role="status" aria-label={t.loading}>
      ...
      <img className="splash-logo" src="/clanify-logo.jpg" alt="Clanify" />
