...
const FEATURES: Feature[] = [
  ...
  { icon: '⏰', title: 'Автонапоминания', desc: 'Личное сообщение не доигравшим за N часов до конца дня. Free — до 5 игроков, Pro — всем.', pro: false },
  { icon: '👉', title: '«Пнуть» не сыгравших', desc: 'Разослать напоминание всем сразу одной кнопкой (Free — до 20 человек).', pro: false },
  { icon: '🔮', title: 'Прогноз клана', desc: 'Сколько медалей наберёте за сегодня и к концу недели, с диапазоном и точностью.', pro: true },
  { icon: '📊', title: 'Pro-аналитика', desc: 'Шанс победы в гонке, здоровье клана и архетип каждого игрока (Тащер, Надёжный…).', pro: true },
  { icon: '📅', title: 'Прошлые войны и сезон', desc: 'Рейтинг игроков за каждую войну (W1, W2…) и суммарный зачёт за весь сезон.', pro: true },
  { icon: '📜', title: 'История по неделям', desc: 'Графики и динамика клана и лично твоя за прошлые недели войн.', pro: true },
]
