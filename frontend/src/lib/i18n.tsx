...
const ru = {
  ...
  notif: {
    ...
    hoursUnit: 'ч',
    warEndTitle: 'Во сколько заканчивается КВ',
    warEndDesc: 'Твоё местное время конца военного дня. От него считаются напоминания и звонок.',
...
const uk: Translations = {
  ...
  notif: {
    ...
    hoursUnit: 'год',
    warEndTitle: 'О котрій закінчується КВ',
    warEndDesc: 'Твій місцевий час кінця воєнного дня. Від нього рахуються нагадування і дзвінок.',
...
const en: Translations = {
  ...
  notif: {
    ...
    hoursUnit: 'h',
    warEndTitle: 'When your war day ends',
    warEndDesc: 'Your local war-day end time. Reminders and the final call are counted from it.',
