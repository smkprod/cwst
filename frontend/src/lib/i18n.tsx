...
const ru = {
  ...
  search: {
    ...
    analysisTiers: { top: 'Топ', strong: 'Сильный', mid: 'Средний', developing: 'Развивается' } as Record<string, string>,
    avgDeckLevel: 'Средний уровень колоды',
    fullDecks: 'полных колод на военный день',
    maxedOf: 'из',
    cardsOnLevel: 'карт на уровне',
    fitsClan: 'Подходит в:',
...
const uk: Translations = {
  ...
  search: {
    ...
    analysisTiers: { top: 'Топ', strong: 'Сильний', mid: 'Середній', developing: 'Розвивається' } as Record<string, string>,
    avgDeckLevel: 'Середній рівень колоди',
    fullDecks: 'повних колод на військовий день',
    maxedOf: 'з',
    cardsOnLevel: 'карт на рівні',
    fitsClan: 'Підходить до:',
...
const en: Translations = {
  ...
  search: {
    ...
    analysisTiers: { top: 'Top', strong: 'Strong', mid: 'Mid', developing: 'Developing' } as Record<string, string>,
    avgDeckLevel: 'Average deck level',
    fullDecks: 'full decks for a war day',
    maxedOf: 'of',
    cardsOnLevel: 'cards at level',
    fitsClan: 'Fits:',
