...
const ru = {
  ...
  /** Страницы клана и игрока — то, что открывается нажатием по строке Аллеи. */
  hallPage: {
    back: 'Назад',
    notRanked: 'Пока не в зачёте сезона',
    medals: 'медалей',
    weeks: 'недель',
    inSeason: 'в зачёте',
    sponsors: 'спонсоров',
    bestWeek: 'лучшая неделя',
    members: '👥 Состав в зачёте',
    noMembers: 'За этот сезон клан ещё никто не набивал.',
    hallRankShort: 'на Аллее',
    weeksChart: '📊 Медали по неделям',
    weekShort: 'Н',
    badges: '🏅 Значки',
    noBadges: 'Значков пока нет.',
    write: '✉️ Написать клану',
    mailOff: 'Этот клан выключил приём сообщений от других кланов.',
    design: '🎨 Оформить страницу',
    designTitle: '🎨 Оформление страницы',
    designHint: 'Видят все, кто открывает клан на Аллее славы.',
    designLocked: 'Остальные оформления открываются клану, в котором есть спонсор.',
    motto: 'Девиз клана',
    mottoPlaceholder: 'Одна строка, которую увидят все',
    save: 'Сохранить',
    saving: 'Сохраняю…',
    saveError: 'Не удалось сохранить',
    playerNotFound: 'Этого игрока нет в зачёте сезона.',
...
const uk: Translations = {
  ...
  hallPage: {
    back: 'Назад',
    notRanked: 'Поки не в заліку сезону',
    medals: 'медалей',
    weeks: 'тижнів',
    inSeason: 'у заліку',
    sponsors: 'спонсорів',
    bestWeek: 'найкращий тиждень',
    members: '👥 Склад у заліку',
    noMembers: 'За цей сезон клану ще ніхто не набивав.',
    hallRankShort: 'на Алеї',
    weeksChart: '📊 Медалі по тижнях',
    weekShort: 'Т',
    badges: '🏅 Значки',
    noBadges: 'Значків поки немає.',
    write: '✉️ Написати клану',
    mailOff: 'Цей клан вимкнув приймання повідомлень від інших кланів.',
    design: '🎨 Оформити сторінку',
    designTitle: '🎨 Оформлення сторінки',
    designHint: 'Бачать усі, хто відкриває клан на Алеї слави.',
    designLocked: 'Решта оформлень відкривається клану, у якому є спонсор.',
    motto: 'Девіз клану',
    mottoPlaceholder: 'Один рядок, який побачать усі',
    save: 'Зберегти',
    saving: 'Зберігаю…',
    saveError: 'Не вдалося зберегти',
    playerNotFound: 'Цього гравця немає в заліку сезону.',
    clanNotFound: 'Клан не знайдено.',
    designs: {
      plain: 'Звичайна',
      royal: 'Королівська',
      gold: 'Золота',
...
const en: Translations = {
  ...
  hallPage: {
    back: 'Back',
    notRanked: 'Not in the season standings yet',
    medals: 'medals',
    weeks: 'weeks',
    inSeason: 'in standings',
    sponsors: 'sponsors',
    bestWeek: 'best week',
    members: '👥 Season roster',
    noMembers: 'Nobody has scored for this clan this season yet.',
    hallRankShort: 'in the Hall',
    weeksChart: '📊 Medals by week',
    weekShort: 'W',
    badges: '🏅 Badges',
    noBadges: 'No badges yet.',
    write: '✉️ Message this clan',
    mailOff: 'This clan has turned off messages from other clans.',
    design: '🎨 Style the page',
    designTitle: '🎨 Page style',
    designHint: 'Everyone who opens the clan in the Hall of Fame sees it.',
    designLocked: 'The other styles unlock for clans that have a sponsor.',
    motto: 'Clan motto',
    mottoPlaceholder: 'One line everyone will see',
    save: 'Save',
    saving: 'Saving…',
    saveError: 'Could not save',
    playerNotFound: 'This player is not in the season standings.',
