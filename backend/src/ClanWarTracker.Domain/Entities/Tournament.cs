...
public class Tournament
{
    ...
    ///
    /// Турниры часто гоняют по одному бою, чтобы уложиться в вечер, но финал в один
    /// бой обесценивает весь путь: чемпион определяется случайностью. Отдельный
    /// формат решает и то и другое.
    /// </summary>
    public int? FinalBestOf { get; set; }
